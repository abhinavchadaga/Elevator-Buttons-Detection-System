...
def main():
    ...
    log_every_n(logging.INFO, "(RECOVERY MODEL) registering datasets...")
    mixed_sets = read_split_file("data/missed_detections/mixed/split.txt")
    ut_west_campus_sets = read_split_file(
        "data/missed_detections/ut_west_campus/split.txt"
    )
    ...
    # FOR RECOVERY MODEL ONLY!!!
    cfg.train.output_dir = "models/recovery_v1"
    cfg.train.finetuned_weights = os.path.join(cfg.train.output_dir, "model_best.pth")
